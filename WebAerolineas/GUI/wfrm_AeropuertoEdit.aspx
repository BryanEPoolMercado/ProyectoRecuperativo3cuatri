<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/mpAerolineas.Master" AutoEventWireup="true" CodeBehind="wfrm_AeropuertoEdit.aspx.cs" Inherits="WebAerolineas.GUI.AeropuertoEdit" %>
...
<div class="group">
    ...
    <br />    
    <asp:TextBox ID="txt_ClaveAeropuerto" runat="server" Width="107px" BorderColor="Black" Enabled="False"></asp:TextBox>
    &nbsp;&nbsp;&nbsp;&nbsp;<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label3" runat="server" Text="Ciudad"></asp:Label>
    <asp:DropDownList ID="ddl_Ciudad" runat="server" Width="417px" BorderColor="Black" Height="29px" DataTextField="Nombre" DataValueField="Id_Ciudad">
    </asp:DropDownList>    
    <br />   
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
